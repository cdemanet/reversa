...
> Conscious decision on how to handle the paradigm change (or absence) between the legacy and the target stack.
> This artifact is a mandatory first read for any subsequent agent and for the coding agent.
...
- **Evidence**:
  - <evidence 1, with reference to artifact in `_reversa_sdd/`>
  - <evidence 2>
...
- **Concrete implications** (not abstract; with example from the actual legacy system):
