...
- **Where the decision will be recorded**: <e.g. `paradigm_decision.md § User's decision`>
...
- In a file: editing this `pending_decisions.md`, adding an `Answer:` field on each item.
