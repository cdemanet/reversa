...
1. **`paradigm_decision.md`**, non-negotiable read. The target paradigm shapes how all coding must happen.
...
11. `discard_log.md` (consultative)
12. `ambiguity_log.md` (consultative)
...
2. **Configure the new repository** with the stack declared in `migration_brief.md`.
...
6. **For the data migration**, follow `data_migration_plan.md`.
