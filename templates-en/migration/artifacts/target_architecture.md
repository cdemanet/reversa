...
## Overview
<Summary in 3 to 6 lines: what the new system is, which paradigm it follows, which edges it has with the legacy during the migration.>
...
- **Traceability**: <reference to the legacy or to the discard_log>
...
## Edges with the legacy during the migration
- <e.g. during Strangler Fig, the new API re-routes calls from legacy X until phase Y>
