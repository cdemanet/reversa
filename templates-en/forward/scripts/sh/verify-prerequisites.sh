...
# Generic prerequisites helper, called by Reversa's forward skills.
#
# Default JSON output on a single line. The agent reads and acts on the fields.
# No external dependencies beyond bash; jq is optional.
#
# Usage:
#   verify-prerequisites.sh [--json] [--require <field>] [--require <field>] ...
#
# Supported fields for --require:
