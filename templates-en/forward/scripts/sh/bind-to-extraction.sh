...
# Helper that reads _reversa_sdd/ and returns a JSON with the canonical sources the forward skills should consult as context.
# REVERSA differentiator: forward skills never start from zero, they always tie their reasoning to the reverse pipeline artifacts.
#
# Usage:
...
#   no --for             Lists all files present in _reversa_sdd/
#
# Exit codes:
#   0 = success
