...
- **When it applies**: <criteria>
- **Cost**: low | medium | high
- **Risk**: low | medium | high
- **Time**: short | medium | long
- **Suitability for the derived appetite** (`<conservative | balanced | transformational>`): <text>
- **Trade-offs**:
  - Pros: <list>
  - Cons: <list>
...
- <e.g.: large paradigm change + transformational appetite → consider Parallel Run for validation>

## Human decision
- **Chosen strategy**: <A | B | C>
- **Who decided**: <name>
- **When**: <ISO-8601>
- **Decider's justification**: <free text>
