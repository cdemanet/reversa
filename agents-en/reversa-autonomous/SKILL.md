...
description: 'Autonomous mode of Reversa: runs the full agent sequence of /reversa end to end, without stops, concentrating the questions into a single interview at the start. For unsupervised sessions (e.g. YOLO mode). Use with "/reversa-autonomous", "autonomous reversa", "run reversa without stopping".'
license: MIT
