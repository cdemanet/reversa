...
- **Where the decision will be saved**: <e.g.: `paradigm_decision.md § User's decision`>

<repeat per decision>

## How to respond

- In chat: answering the agent directly with the option number and justification.
- In file: editing this `pending_decisions.md`, adding a `Resposta:` field in each item.
