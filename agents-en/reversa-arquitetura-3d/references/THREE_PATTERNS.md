...
Quick reference of setup, materials and techniques common to all skill modes. Three.js v0.158+, ESM via CDN.
...
```javascript
// Soft ambient light so shadows aren't fully black
...
// Directional: simulates sun, projects shadows
...
| InstancedMesh of cubes | 5,000 | Apply folder grouping |
