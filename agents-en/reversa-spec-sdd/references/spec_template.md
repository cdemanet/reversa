...
> Usage instructions: replace all text in `[brackets]` with real content.
...
> *1–3 sentences. What is this feature and why does it exist? Read this and already understand the objective.*
...
> *Each goal must be verifiable — if you can't measure, reformulate.*
...
> *Describe UI/UX behavior, not the visuals. Wireframes can be referenced.*
...
> *This section is where specs usually fail. Think about difficult cases.*
...
- **Audit:** [Is audit logging needed? What should be logged?]
...
- **How to reverse (rollback):** [Steps to undo if something goes wrong]
...
> *Unresolved doubts that may impact design. Each item must have an owner and deadline.*
