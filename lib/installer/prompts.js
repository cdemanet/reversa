...
const DOCS_TEAM = [
  // Orchestrator and 4 expert agents
  'reversa-docs',
  'reversa-docs-mapper',
...
export async function runInstallPrompts(detectedEngines) {
  ...
  const teamChoices = [
    ...
    { name: `Code New Project Agents ${chalk.gray('(requires Code Forward Agents)')}`, value: 'newproject', checked: true },
    { name: 'Code Quality Agents (refactoring, optimization, dead code)', value: 'refactor', checked: true },
  ...
  // Discovery and Bugs are fixed groups: always installed, as the core
